...
// IDs de las fotos que me proporcionaste
const bannerImageId = '1d0bMVmSk2pMe6S3ZgG0bKeSPS_Yfd9Ul'; 
const photoIds = [
...
export default async function EventPage({ params }: { params: { eventId: string } }) {
  ...
  const mockEvent = {
    id: eventId,
    name: `Evento de Muestra ${eventId}`, // Puedes ajustar el nombre si es necesario
  ...
  const photos = photoIds.map((id, index) => ({
    ...
    photographer: `Fotógrafo ${index + 1}`, // Placeholder
